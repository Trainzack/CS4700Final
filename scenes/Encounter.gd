...
var encounter_template_scene = preload("res://encounters/boardTemplate.gd")
...
var suffixes = [" Camp", " Town", " Village", "ville", "borough", " Castle", " Keep", " Court", " Field", " Valley", " River", " Lake"]
var black_team = []
var white_team = []
...
var encounter_types = {
	...
	"tut3":	[[
		...
		"........",
		"........",
	],[[3,0,"U",1],[4,0,"G",1],[5,0,"C",1],[6,0,"R",1],[4,1,"P",1],[5,1,"P",1],[2,7,"U",0],[3,7,"G",0],[4,7,"C",0],[5,7,"R",0],[3,6,"P",0],[4,6,"P",0]]],
	"mini":	[[
		"M......M",
		"M......M",
		"...MM...",
		...
		"M......M",
		"MM....MM",
	],[[2,0,"R",1],[3,0,"N",1],[4,0,"N",1],[5,0,"G",1],[6,0,"E",1],[4,5,"C",0],[5,5,"N",0],[3,5,"N",0]]],
	"final":	[[
		"........",
		".M~..~M.",
		".~....~.",
...
func determine_x_position(last_x_position):
	if last_x_position == 3:
		return 4
	if last_x_position == 4:
		return 2
	if last_x_position == 2:
		return 5
	if last_x_position == 5:
		return 1
...
func set_teams(input_white_team,input_black_team):
	...
	black_team = input_black_team

func place_teams(board):
	#Place white units
	var x_position = 3
	var placed_units = 0
	var row = 0
	for unit in white_team:
		...
		placed_units += 1
		#If all 6 have been placed in first row, move up a row.
		if(placed_units == 6):
			row += 1
	x_position = 3
	placed_units = 0
